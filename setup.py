...
about = {}
with open(os.path.join(here, 'circuitbrew', 'version.py')) as f:
    exec(f.read(), about)
...
setup (
    ...
    description="Python circuit generator for SPICE and Verilog",
    license = "ASL 2.0",
    ...
    entry_points = {
            'console_scripts': [
                    'circuitbrew = circuitbrew.circuitbrew:main'
                ],
        },
    options = {
